...
```sh
docker run --rm -v ${PWD}:/docs sig9/zensical:0.0.58 zensical build --clean
```

## DockerHub Supported tags

- [0.0.58](https://hub.docker.com/repository/docker/sig9/zensical/tags/0.0.58/)
- [0.0.57](https://hub.docker.com/repository/docker/sig9/zensical/tags/0.0.57/)
- [0.0.56](https://hub.docker.com/repository/docker/sig9/zensical/tags/0.0.56/)
- [0.0.55](https://hub.docker.com/repository/docker/sig9/zensical/tags/0.0.55/)
- [0.0.54](https://hub.docker.com/repository/docker/sig9/zensical/tags/0.0.54/)
- [0.0.53](https://hub.docker.com/repository/docker/sig9/zensical/tags/0.0.53/)
- [0.0.52](https://hub.docker.com/repository/docker/sig9/zensical/tags/0.0.52/)
- [0.0.51](https://hub.docker.com/repository/docker/sig9/zensical/tags/0.0.51/)
...
build-job:
    stage: build
    script:
        - docker run --user $(id -u):$(id -g) --rm -v ${PWD}:/docs sig9/zensical:0.0.58 zensical build --clean
        - rm -rf /var/www/html/*
